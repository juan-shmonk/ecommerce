...
/* package shopping-cart-backend-0.1.0.0 */
#ifndef VERSION_shopping_cart_backend
#define VERSION_shopping_cart_backend "0.1.0.0"
#endif /* VERSION_shopping_cart_backend */
#ifndef MIN_VERSION_shopping_cart_backend
#define MIN_VERSION_shopping_cart_backend(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_shopping_cart_backend */
...
#define CURRENT_COMPONENT_ID "shopping-cart-backend-0.1.0.0-inplace-shopping-cart-backend"
